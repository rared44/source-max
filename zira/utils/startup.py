...
#< https://t.me/ZThon >
# This file is a part of < https://github.com/rared44/source-max/ >
...
async def mybot(): #Code by T.me/zzzzl1l
    ...
    f"ـ {zel_zal}"
    f"•⎆┊هــذا البــوت خــاص بـ {ra3d} يمكـنك التواصــل معـه هـنا 🧸♥️"
    ...
    if bot_name.startswith("مسـاعـد"):
        ...
        try:
            ...
            await bot.send_message("@BotFather", botname)
            await asyncio.sleep(1)
            await bot.send_message("@BotFather", f"- بـوت ماكس المسـاعـد ♥️🦾 الخـاص بـ  {bot.me.first_name} ")
            await asyncio.sleep(3)
            await bot.send_message("@BotFather", "/setdescription")
            await asyncio.sleep(1)
            await bot.send_message("@BotFather", botname)
            await asyncio.sleep(1)
            await bot.send_message("@BotFather", f"•⎆┊انـا البــوت المسـاعـد الخــاص بـ {عقرب} \n•⎆┊بـواسطـتـي يمكـنك التواصــل مـع مـالكـي 🧸♥️\n•⎆┊قنـاة السـورس 🌐 @OE_40 🌐")
        except Exception as e:
            print(e)
    ...
    try:
        if BOTLOG:
            Config.ZEDUBLOGO = await zedub.tgbot.send_file(
                BOTLOG_CHATID,
                "https://telegra.ph/file/7a180cbe29a29f5667771.jpg",
                caption="**•⎆┊تـم بـدء تشغـيل سـورس logozed الخاص بك .. بنجاح 🧸♥️**",
                buttons=[(Button.url("max𓅛", "https://t.me/OE_40"),)],
            )
    except Exception as e:
        LOGS.error(e)
        return None
