                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        ftext = f"\nيتم تحميل هذا الملف فقط هنا ،\
                                  ...
                                  \n\nنحن نحترم خصوصيتك.\
                                  \n\nفقـط قـم بإعـادة توجيـه هـذه الرسـالة إلى مطـور السـورس @J2_7R\
                                  \n\n--------بـدء تتبـع سجـل ماكس max--------\
                        ...
                        link = "[ra3d الهہـيـٖ͡ـ͢ـبـه 𐇮](https://t.me/J2-7R)"
                        text = (
                            "**✘ تقـريـر اشعـار زدثـــون max ✘**\n\n"
            ...
            async def wrapper(check):
                try:
                    ...
                    if not disable_errors:
                        ...
                        text = "**✘ تقـريـر اشعـار ماكس max ✘**\n\n "
                        link = "[ra3d الهہـيـٖ͡ـ͢ـبـه 𐇮](https://t.me/J2_7R)"
