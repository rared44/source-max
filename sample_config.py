...
class Config(object):
    ...
    TZ = os.environ.get("TZ", "ِِAfrica/Cairo")
    # set this with required zed repo link
    UPSTREAM_REPO = os.environ.get(
        "UPSTREAM_REPO", "https://github.com/rared44/source-max.git
"
    )
    ...
    THUMB_IMAGE = os.environ.get(
        "THUMB_IMAGE", "https://telegra.ph/file/7a180cbe29a29f5667771.jpg"
    )
    ...
    # For updater plugin
    UPSTREAM_REPO_BRANCH = os.environ.get("UPSTREAM_REPO_BRANCH", "max-thone")
    ...
    OLDZED_REPO = os.environ.get("OLDZED_REPO", "https://github.com/rared44/source-max.git
")
    if OLDZED_REPO and not url(OLDZED_REPO)

        OLDZED_REPO = "https://github.com/rared44/source-max.git
"
